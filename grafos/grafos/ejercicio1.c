...
/*
  SOLUCIONAR ERROR GRAFO NO CONEXO
  Cuando le pasamos el vertice 6 como inicio, hay vertices que no son alcanzados.
  Hay que buscar el primer vertice que no ha sido alcanzado e invocar de nuevo el algoritmo de recorrido.
  Si no ha sido visitado, invocas la funcion profundidad con ese que no ha sido invocado. 
  Por tanto hay que crear una funcion amplitudMejorada y profundidadMejorada
